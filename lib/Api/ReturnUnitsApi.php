...
class ReturnUnitsApi
{
     ...
     *
     * @param  int $idReturnUnit Return unit ID, unique across all return units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ReturnUnitClarifyRequest $returnUnitClarifyRequest Request body containing message for clarifying return unit (required)
     ...
     *
     * @param  int $idReturnUnit Return unit ID, unique across all return units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ReturnUnitEmbeddable[]|null $embedded Additional data to be returned (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnUnitWithHttpInfo($idReturnUnit, $embedded = null, string $contentType = self::contentTypes['getReturnUnit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails', []),
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseReturnUnitDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\ReturnUnitStatus[]|null $status Get only return units which are in the given status (optional)
     * @param  \OpenAPI\Client\Kaufland\Model\FulfillmentType[]|null $fulfillmentType Get only return units which are fulfilled by the given type.&lt;br/&gt; The value &#x60;fulfilled_by_kaufland&#x60; is **DEPRECATED**. (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReturnUnitsWithHttpInfo($storefront = null, $tsCreatedFromIso = null, $status = null, $fulfillmentType = null, $sort = 'ts_created:desc', $limit = null, $offset = null, string $contentType = self::contentTypes['getReturnUnits'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReturnUnit',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $idReturnUnit Return unit ID, unique across all return units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ReturnUnitRejectRequest $returnUnitRejectRequest Request body containing message for rejecting return unit (required)
