...
namespace OpenAPI\Client\Kaufland\Api;
...
use OpenAPI\Client\Kaufland\HeaderSelector;
...
class ImportFilesApi
{
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFileInventoryCommandPostRequest $importFileInventoryCommandPostRequest importFileInventoryCommandPostRequest (required)
     ...
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFileInventoryCommandPostRequest $importFileInventoryCommandPostRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createInventoryCommandImportFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInventoryCommandImportFileWithHttpInfo($storefront, $importFileInventoryCommandPostRequest, string $contentType = self::contentTypes['createInventoryCommandImportFile'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Kaufland\Model\ErrorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ErrorResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ErrorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFileInventoryFeedPostRequest $importFileInventoryFeedPostRequest importFileInventoryFeedPostRequest (required)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFileInventoryFeedPostRequest $importFileInventoryFeedPostRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createInventoryFeedImportFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInventoryFeedImportFileWithHttpInfo($storefront, $importFileInventoryFeedPostRequest, string $contentType = self::contentTypes['createInventoryFeedImportFile'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFileOrderCommandPostRequest $importFileOrderCommandPostRequest importFileOrderCommandPostRequest (required)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * Add an ORDER_COMMAND file URL
     *
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFileOrderCommandPostRequest $importFileOrderCommandPostRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createOrderCommandImportFile'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOrderCommandImportFileWithHttpInfo($importFileOrderCommandPostRequest, string $contentType = self::contentTypes['createOrderCommandImportFile'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\ImportStatus|null $status File status filter (optional)
     * @param  \DateTime|null $tsCreatedIso tsCreatedIso (optional)
     * @param  \DateTime|null $tsUpdatedIso tsUpdatedIso (optional)
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFilesSortBy|null $sort sort (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\ImportFilesSortBy|null $sort (optional)
     * @param  int|null $limit Desired size of result set (optional, default to 30)
     * @param  int|null $offset Offset applied to result set (optional, default to 0)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInventoryCommandImportFiles'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryCommandImportFilesWithHttpInfo($storefront, $status = null, $tsCreatedIso = null, $tsUpdatedIso = null, $sort = null, $limit = 30, $offset = 0, string $contentType = self::contentTypes['getInventoryCommandImportFiles'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryCommand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileInventoryFeed|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInventoryFeedImportFilesWithHttpInfo($storefront, $status = null, $tsCreatedIso = null, $tsUpdatedIso = null, $sort = null, $limit = 30, $offset = 0, string $contentType = self::contentTypes['getInventoryFeedImportFiles'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileInventoryFeed',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseImportFileOrderCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderCommandImportFilesWithHttpInfo($status = null, $tsCreatedIso = null, $tsUpdatedIso = null, $sort = null, $limit = 30, $offset = 0, string $contentType = self::contentTypes['getOrderCommandImportFiles'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseImportFileOrderCommand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
