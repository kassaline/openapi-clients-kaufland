...
class UnitsApi
{
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateRequest[] $unitsBulkUpdateRequest Update Object (required)
     ...
     * @return \OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkUpdateUnitsWithHttpInfo($storefront, $unitsBulkUpdateRequest, string $contentType = self::contentTypes['bulkUpdateUnits'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 207:
                    if ('\OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse';
            ...
            switch ($e->getCode()) {
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\UnitsBulkUpdateResponse',
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\UnitRequest $unitRequest Information about the unit that will be generated (required)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUnitWithHttpInfo($storefront, $unitRequest, string $contentType = self::contentTypes['createUnit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseUnit' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseUnit' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseUnit', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseUnit';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseUnit',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $idUnit Internal ID of Unit, unique across all Units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\UnitEmbeddedEnum[]|null $embedded embedded (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @param  int $idUnit Internal ID of Unit, unique across all Units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\UnitEmbeddedEnum[]|null $embedded (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getUnit'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\UnitEmbeddedEnum[]|null $embedded embedded (optional)
     * @param  \OpenAPI\Client\Kaufland\Model\FulfillmentType[]|null $fulfillmentType Get only units which are fulfilled by the given type. &lt;br/&gt; The value &#x60;fulfilled_by_kaufland&#x60; is **DEPRECATED**. (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUnitsWithHttpInfo($storefront, $limit = 30, $offset = 0, $idOffer = null, $idProduct = null, $ean = null, $embedded = null, $fulfillmentType = null, string $contentType = self::contentTypes['getUnits'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseUnitEmbedded',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $idUnit Internal ID of Unit, unique across all Units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\UnitPatchRequest $unitPatchRequest Update Object (required)
