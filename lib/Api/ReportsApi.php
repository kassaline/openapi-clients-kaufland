...
class ReportsApi
{
     ...
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseReport|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseReport|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportWithHttpInfo($idReport, string $contentType = self::contentTypes['getReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseReport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseReport' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseReport', []),
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseReport';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseReport',
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\ReportsSorting|null $sort Sorting of result set (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportsWithHttpInfo($storefront = null, $limit = 30, $offset = 0, $sort = null, string $contentType = self::contentTypes['getReports'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseReport',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\AccountListingReportVersion|null $version Parameter to select the preferred version (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestAccountListingReportWithHttpInfo($storefront, $version = null, string $contentType = self::contentTypes['requestAccountListingReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseRequestedReport',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\CancellationType|null $cancellationType Filter to select what cancellations are Considered (defaults to no filter applied) (optional)
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\RequestBookingsReportRequest $requestBookingsReportRequest requestBookingsReportRequest (required)
     * @param  \OpenAPI\Client\Kaufland\Model\BookingsReportVersion|null $version Parameter to select the preferred version (optional)
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\RequestBookingsReportRequest $requestBookingsReportRequest (required)
     * @param  \OpenAPI\Client\Kaufland\Model\BookingsReportVersion|null $version Parameter to select the preferred version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['requestNewBookingsReport'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\RequestNewSalesReportRequest $requestNewSalesReportRequest requestNewSalesReportRequest (required)
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\Storefront $storefront Parameter to select the affected storefront (required)
     * @param  \OpenAPI\Client\Kaufland\Model\RequestNewSalesReportRequest $requestNewSalesReportRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['requestNewSalesReport'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \OpenAPI\Client\Kaufland\Model\RequestProductDataImportFileErrorsReportRequest $requestProductDataImportFileErrorsReportRequest requestProductDataImportFileErrorsReportRequest (required)
     ...
     * Queue a product data import file errors report
     *
     * @param  \OpenAPI\Client\Kaufland\Model\RequestProductDataImportFileErrorsReportRequest $requestProductDataImportFileErrorsReportRequest (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['requestProductDataImportFileErrorsReport'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
