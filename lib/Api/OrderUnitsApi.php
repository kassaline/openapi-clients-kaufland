...
class OrderUnitsApi
{
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\OrderUnitCancelRequest $orderUnitCancelRequest Reason of the cancellation (required)
     ...
     *
     * @param  int $idOrderUnit Order unit ID, unique across all order units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\OrderUnitEmbeddable[]|null $embedded Additional data to be returned (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderUnitWithHttpInfo($idOrderUnit, $embedded = null, string $contentType = self::contentTypes['getOrderUnit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails', []),
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\ApiResponseOrderUnitDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\OrderUnitStatus[]|null $status Get only order units which are in the given status (optional)
     ...
     * @param  \OpenAPI\Client\Kaufland\Model\FulfillmentType[]|null $fulfillmentType Get only order units which are fulfilled by the given type. &lt;br/&gt; The value &#x60;fulfilled_by_kaufland&#x60; is **DEPRECATED**. (optional)
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\Kaufland\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse|\OpenAPI\Client\Kaufland\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderUnitsWithHttpInfo($storefront = null, $idOffer = null, $status = null, $tsCreatedFromIso = null, $tsUpdatedFromIso = null, $fulfillmentType = null, $sort = 'ts_created:desc', $limit = 30, $offset = 0, string $contentType = self::contentTypes['getOrderUnits'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Kaufland\Model\CollectionApiResponseOrderUnit',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $idOrderUnit Order unit ID, unique across all order units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\OrderUnitRefundRequest $orderUnitRefundRequest Request body containing amount and reason of the refund. (required)
     ...
     *
     * @param  int $idOrderUnit Order unit ID, unique across all order units (required)
     * @param  \OpenAPI\Client\Kaufland\Model\OrderUnitSendRequest $orderUnitSendRequest Request body containing tracking number(s) and carrier code of the shipment(s) (required)
