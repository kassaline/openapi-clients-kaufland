 ...
 */
class UnitsBulkUpdateInternalError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnitsBulkUpdateInternalError';
    ...
    */
    ...
    public function setIdUnit($idUnit)
    {
        ...
        if (($idUnit < 1)) {
            throw new \InvalidArgumentException('invalid value for $idUnit when calling UnitsBulkUpdateInternalError., must be bigger than or equal to 1.');
        }
    ...
    public function setStatusCode($statusCode)
    {
        ...
        if (($statusCode < 200)) {
            throw new \InvalidArgumentException('invalid value for $statusCode when calling UnitsBulkUpdateInternalError., must be bigger than or equal to 200.');
        }
