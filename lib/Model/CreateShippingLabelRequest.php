...
class CreateShippingLabelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'idsOrderUnits' => 'int[]',
        'carriers' => 'string[]',
        'packageMeasurements' => '\OpenAPI\Client\Kaufland\Model\PackageMeasurements'
    ];
    ...
    protected static $setters = [
        ...
        'packageMeasurements' => 'setPackageMeasurements'
    ];
    ...
    protected static $getters = [
        ...
        'packageMeasurements' => 'getPackageMeasurements'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('packageMeasurements', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['packageMeasurements'] === null) {
            $invalidProperties[] = "'packageMeasurements' can't be null";
        }
     ...
     * Sets idsOrderUnits
     *
     * @param int[] $idsOrderUnits idsOrderUnits
     *
     * @return self
     */
    ...
    /**
     * Gets packageMeasurements
     *
     * @return \OpenAPI\Client\Kaufland\Model\PackageMeasurements
     */
    public function getPackageMeasurements()
    {
        return $this->container['packageMeasurements'];
    }

    /**
     * Sets packageMeasurements
     *
     * @param \OpenAPI\Client\Kaufland\Model\PackageMeasurements $packageMeasurements packageMeasurements
     *
     * @return self
     */
    public function setPackageMeasurements($packageMeasurements)
    {
        if (is_null($packageMeasurements)) {
            throw new \InvalidArgumentException('non-nullable packageMeasurements cannot be null');
        }
        $this->container['packageMeasurements'] = $packageMeasurements;
