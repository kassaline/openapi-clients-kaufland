...
class ProductDataImportFileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'idImportFile' => 'int',
        'uri' => 'string',
        'status' => '\OpenAPI\Client\Kaufland\Model\ProductDataImportFileStatus',
        'note' => 'string',
        'totalLines' => 'float',
        'currentLine' => 'float',
        'tsCreated' => 'string',
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Kaufland\Model\ProductDataImportFileStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Kaufland\Model\ProductDataImportFileStatus $status status
     *
     * @return self
     */
