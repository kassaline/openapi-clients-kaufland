...
/**
 * OpenTicketResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Kaufland
 * @author   OpenAPI Generator team
 ...
 */
class OpenTicketResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenTicketResponse';
    ...
    */
    ...
    public function setIdTicket($idTicket)
    {
        ...
        if ((!preg_match("/^001\\d+$/", ObjectSerializer::toString($idTicket)))) {
            throw new \InvalidArgumentException("invalid value for \$idTicket when calling OpenTicketResponse., must conform to the pattern /^001\\d+$/.");
        }
