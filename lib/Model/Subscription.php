...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eventName' => '\OpenAPI\Client\Kaufland\Model\SubscriptionEventName',
        'isActive' => 'bool',
        'storefront' => 'string'
    ];
    ...
    protected static $setters = [
        'idSubscription' => 'setIdSubscription',
    ...
    protected static $getters = [
        'idSubscription' => 'getIdSubscription',
    ...
    {
        $this->setIfExists('idSubscription', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['idSubscription'] === null) {
            $invalidProperties[] = "'idSubscription' can't be null";
        }
        if ($this->container['callbackUrl'] === null) {
            $invalidProperties[] = "'callbackUrl' can't be null";
        }
        if ($this->container['fallbackEmail'] === null) {
            $invalidProperties[] = "'fallbackEmail' can't be null";
        }
    ...
    {
        return $this->container['idSubscription'];
    }

    /**
     * Sets idSubscription
     *
     * @param float $idSubscription idSubscription
     *
     * @return self
     */
    public function setIdSubscription($idSubscription)
    {
        if (is_null($idSubscription)) {
            throw new \InvalidArgumentException('non-nullable idSubscription cannot be null');
        }
        $this->container['idSubscription'] = $idSubscription;
     ...
     * Sets fallbackEmail
     *
     * @param string $fallbackEmail fallbackEmail
     *
     * @return self
     */
     ...
     * Gets eventName
     *
     * @return \OpenAPI\Client\Kaufland\Model\SubscriptionEventName
     */
     ...
     * Sets eventName
     *
     * @param \OpenAPI\Client\Kaufland\Model\SubscriptionEventName $eventName eventName
     *
     * @return self
     */
