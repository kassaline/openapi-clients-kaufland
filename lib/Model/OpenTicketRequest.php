...
/**
 * OpenTicketRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Kaufland
 * @author   OpenAPI Generator team
 ...
 */
class OpenTicketRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenTicketRequest';
    ...
    protected static $openAPITypes = [
        'idOrderUnit' => 'int[]',
        'reason' => '\OpenAPI\Client\Kaufland\Model\TicketReason',
        'message' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['idOrderUnit']) < 1)) {
            $invalidProperties[] = "invalid value for 'idOrderUnit', number of items must be greater than or equal to 1.";
        }
    ...
    public function setIdOrderUnit($idOrderUnit)
    {
        ...
        if ((count($idOrderUnit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idOrderUnit when calling OpenTicketRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets reason
     *
     * @param \OpenAPI\Client\Kaufland\Model\TicketReason $reason reason
     *
     * @return self
     */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling OpenTicketRequest., must be bigger than or equal to 1.');
        }
