...
class OrderInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('idInvoice', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['idInvoice'] === null) {
            $invalidProperties[] = "'idInvoice' can't be null";
        }
    ...
    {
        return $this->container['idInvoice'];
    }

    /**
     * Sets idInvoice
     *
     * @param int $idInvoice idInvoice
     *
     * @return self
     */
    public function setIdInvoice($idInvoice)
    {
        if (is_null($idInvoice)) {
            throw new \InvalidArgumentException('non-nullable idInvoice cannot be null');
        }
        $this->container['idInvoice'] = $idInvoice;
