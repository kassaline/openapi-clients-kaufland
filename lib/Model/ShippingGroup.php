...
class ShippingGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'type' => '\OpenAPI\Client\Kaufland\Model\SellerApiShippingGroupType',
        'isDefault' => 'bool',
        'regions' => '\OpenAPI\Client\Kaufland\Model\ShippingGroupRegion[]'
    ];
    ...
    */
    ...
    public function setIdShippingGroup($idShippingGroup)
    {
        ...
        if (($idShippingGroup < 1)) {
            throw new \InvalidArgumentException('invalid value for $idShippingGroup when calling ShippingGroup., must be bigger than or equal to 1.');
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Kaufland\Model\SellerApiShippingGroupType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Kaufland\Model\SellerApiShippingGroupType $type type
     *
     * @return self
     */
     ...
     * Gets regions
     *
     * @return \OpenAPI\Client\Kaufland\Model\ShippingGroupRegion[]
     */
     ...
     * Sets regions
     *
     * @param \OpenAPI\Client\Kaufland\Model\ShippingGroupRegion[] $regions List of regions in this shipping group
     *
     * @return self
     */
