...
/**
 * ProductCategoriesImportFileResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Kaufland
 * @author   OpenAPI Generator team
 ...
 */
class ProductCategoriesImportFileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductCategoriesImportFileResponse';
    ...
    protected static $openAPITypes = [
        'idImportFile' => 'int',
        'uri' => 'string',
        'status' => '\OpenAPI\Client\Kaufland\Model\ProductCategoriesImportFileStatus',
        'note' => 'string',
        'totalLines' => 'float',
        'currentLine' => 'float',
        'tsCreated' => 'string',
    ...
    */
    ...
    public function setIdImportFile($idImportFile)
    {
        ...
        if (($idImportFile < 1)) {
            throw new \InvalidArgumentException('invalid value for $idImportFile when calling ProductCategoriesImportFileResponse., must be bigger than or equal to 1.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Kaufland\Model\ProductCategoriesImportFileStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Kaufland\Model\ProductCategoriesImportFileStatus $status status
     *
     * @return self
     */
