...
/**
 * ImportFileInventoryFeed Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Kaufland
 * @author   OpenAPI Generator team
 ...
 */
class ImportFileInventoryFeed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportFileInventoryFeed';
    ...
    protected static $openAPITypes = [
        ...
        'idImportFile' => 'int',
        'note' => 'string',
        'status' => '\OpenAPI\Client\Kaufland\Model\ImportStatus',
        'totalLines' => 'int',
        'tsCompletedIso' => '\DateTime',
        'tsCreatedIso' => '\DateTime',
        'tsLastRowUpdatedIso' => '\DateTime',
        'tsUpdatedIso' => '\DateTime',
        'type' => '\OpenAPI\Client\Kaufland\Model\ImportType',
        'uri' => 'string'
    ];
    ...
    */
    ...
    public function setIdImportFile($idImportFile)
    {
        ...
        if (($idImportFile < 1)) {
            throw new \InvalidArgumentException('invalid value for $idImportFile when calling ImportFileInventoryFeed., must be bigger than or equal to 1.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Kaufland\Model\ImportStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Kaufland\Model\ImportStatus $status status
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Kaufland\Model\ImportType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Kaufland\Model\ImportType $type type
     *
     * @return self
     */
