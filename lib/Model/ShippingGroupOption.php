...
class ShippingGroupOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => '\OpenAPI\Client\Kaufland\Model\SellerApiShippingGroupRegionOptionNameEnum',
        'costFirst' => 'int',
        'costNext' => 'int',
        'costMax' => 'int',
        'costFree' => 'int',
    ...
    */
     ...
     * Gets name
     *
     * @return \OpenAPI\Client\Kaufland\Model\SellerApiShippingGroupRegionOptionNameEnum
     */
     ...
     * Sets name
     *
     * @param \OpenAPI\Client\Kaufland\Model\SellerApiShippingGroupRegionOptionNameEnum $name name
     *
     * @return self
     */
