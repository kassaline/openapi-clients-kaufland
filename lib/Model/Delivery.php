...
class Delivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'pickupLocation' => '\OpenAPI\Client\Kaufland\Model\PickupLocation'
    ];
    ...
    {
        $this->setIfExists('pickupLocation', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets pickupLocation
     *
     * @return \OpenAPI\Client\Kaufland\Model\PickupLocation
     */
     ...
     * Sets pickupLocation
     *
     * @param \OpenAPI\Client\Kaufland\Model\PickupLocation $pickupLocation pickupLocation
     *
     * @return self
     */
    public function setPickupLocation($pickupLocation)
    {
        if (is_null($pickupLocation)) {
            array_push($this->openAPINullablesSetToNull, 'pickupLocation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickupLocation', $nullablesSetToNull);
            if ($index !== FALSE) {
