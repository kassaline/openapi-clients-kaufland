...
class UnitPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => '\OpenAPI\Client\Kaufland\Model\WriteableUnitStatuses',
        'amount' => 'int',
        'handlingTime' => 'int',
        'listingPrice' => 'int',
        'minimumPrice' => 'int',
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Kaufland\Model\WriteableUnitStatuses|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Kaufland\Model\WriteableUnitStatuses|null $status status
     *
     * @return self
     */
