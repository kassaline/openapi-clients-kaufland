...
class UnitsBulkUpdatedUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setIdUnit($idUnit)
    {
        ...
        if (($idUnit < 1)) {
            throw new \InvalidArgumentException('invalid value for $idUnit when calling UnitsBulkUpdatedUnit., must be bigger than or equal to 1.');
        }
    ...
    public function setStatusCode($statusCode)
    {
        ...
        if (($statusCode < 200)) {
            throw new \InvalidArgumentException('invalid value for $statusCode when calling UnitsBulkUpdatedUnit., must be bigger than or equal to 200.');
        }
