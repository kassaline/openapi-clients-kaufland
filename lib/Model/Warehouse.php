...
class Warehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'idWarehouse' => 'int',
        'name' => 'string',
        'address' => '\OpenAPI\Client\Kaufland\Model\WarehouseAddress',
        'isDefault' => 'bool',
        'type' => '\OpenAPI\Client\Kaufland\Model\SellerApiWarehouseType'
    ];
    ...
    */
     ...
     * Sets idWarehouse
     *
     * @param int $idWarehouse Internal ID of Warehouse, unique across all Warehouses
     *
     * @return self
     */
    public function setIdWarehouse($idWarehouse)
    {
        ...
        if (($idWarehouse < 1)) {
            throw new \InvalidArgumentException('invalid value for $idWarehouse when calling Warehouse., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Kaufland\Model\WarehouseAddress
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Kaufland\Model\WarehouseAddress $address address
     *
     * @return self
     */
     ...
     * Sets isDefault
     *
     * @param bool $isDefault Is this Warehouse set as default for you.
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Kaufland\Model\SellerApiWarehouseType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Kaufland\Model\SellerApiWarehouseType $type type
     *
     * @return self
     */
