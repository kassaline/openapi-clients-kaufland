...
class CategoryTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fixedFee' => 'float',
        'vat' => 'float',
        'children' => '\OpenAPI\Client\Kaufland\Model\CategoryTree[]'
    ];
    ...
    */
    ...
    public function setIdCategory($idCategory)
    {
        ...
        if (($idCategory < 1)) {
            throw new \InvalidArgumentException('invalid value for $idCategory when calling CategoryTree., must be bigger than or equal to 1.');
        }
    ...
    public function setIdParentCategory($idParentCategory)
    {
        ...
        if (($idParentCategory < 1)) {
            throw new \InvalidArgumentException('invalid value for $idParentCategory when calling CategoryTree., must be bigger than or equal to 1.');
        }
     ...
     * Gets children
     *
     * @return \OpenAPI\Client\Kaufland\Model\CategoryTree[]
     */
     ...
     * Sets children
     *
     * @param \OpenAPI\Client\Kaufland\Model\CategoryTree[] $children children
     *
     * @return self
     */
